...
router.get('/:code', app_auth, session_verify, campagne_controller.getCampagne);
router.put('/:code', app_auth, session_verify, campagne_controller.updateCampagne);

router.get('/:code/parties', app_auth, session_verify, pr_partie_controller.getAllCampagnePrParties);
...
router.get('/parties/:p_ref/questions', app_auth, session_verify, pr_question_controller.getAllPrPartieQuestions);
...
router.get('/questions/:q_ref/matrices', app_auth, session_verify, pr_repmatrice_controller.getAllPrQuestRepMatrice);
...
router.get('/matrices/:rm_ref/reponses', app_auth, session_verify, pr_reponse_controller.getAllMReponses);
