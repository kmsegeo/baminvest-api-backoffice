...
// router.get('/inactif', app_auth, session_verify, clientController.loadWaitingActivation);
...
// router.get('/operations/type/:code', app_auth, session_verify, operationController.loadAllByTypeOperation)
...
router.get('/operations/:ref', app_auth, session_verify, operationController.loadOperation);
